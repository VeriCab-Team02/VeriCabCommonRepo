...
export function addOffersBythunk(){
    ...
    return function(dispatch){
        ...
        return axios.post("http://localhost:8080/addOffers",restStore.getState().newOffer,{headers: {'Accept': 'application/json'}})
...
export function getOfferByThunk(){
    ...
    return function(dispatch){
        ...
        return axios.get("http://localhost:8080/viewOffers").
        then(resp=>dispatch(getOffersAction(resp.data,true)));
...
export function deleteByThunk(){
    ...
    return axios.delete("http://localhost:8080/deleteOffer/"+restStore.getState().id)
